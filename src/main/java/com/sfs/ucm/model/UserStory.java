...
public class UserStory extends EntityBase implements Serializable {
	 ...
	 * Constructor
	 */
	public UserStory(int identifier) {
		super();
	...
	public String getArtifact() {
		return ModelUtils.buildArtifactIdentifier(Literal.PREFIX_USERSTORY.toString(), this.identifier);
	}
