...
import com.sfs.ucm.util.ProjectMemberInit;
import com.sfs.ucm.util.ProjectMemberUpdated;

@Stateful
@SessionScoped
public class ProjectMemberProducer implements Serializable {
	...
	/**
	 * project member event
	 * 
	 * @param project
	 */
	public void onProjectMemberInit(@Observes @ProjectMemberInit final Project project) {
		if (this.projectMembers == null || !project.equals(this.project)) {
			load(project);
		}
	 ...
	 * @param project
	 */
	public void onProjectMemberUpdate(@Observes @ProjectMemberUpdated final Project project) {
		load(project);
	}
