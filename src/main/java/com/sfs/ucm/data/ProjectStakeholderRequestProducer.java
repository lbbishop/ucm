...
@Stateful
@SessionScoped
public class ProjectStakeholderRequestProducer implements Serializable {
	...
	/**
	 * project stakeholderRequest update event
	 * 
	 * @param project
	 */
	public void onProjectStakeholderRequestInit(@Observes @ProjectStakeholderRequestInit final Project project) {
		if (this.stakeholderRequests == null || !project.equals(this.project)) {
			load(project);
		}
	 ...
	 * @param project
	 */
	public void onProjectStakeholderRequestUpdate(@Observes @ProjectStakeholderRequestUpdated final Project project) {
		load(project);
	}
	 ...
	 * Producer
	 * 
	 * @return List of project stakeholderRequests
	 */
	@Produces
	@Named
	public List<StakeholderRequest> getProjectStakeholderRequests() {
